...
static struct amount_bro calc_fee(const struct brocoin_tx *tx, struct amount_bro input)
{
	...
	for (i = 0; i < tal_count(tx->output); i++)
		output.broneess += tx->output[i].amount;
...
int main(int argc, const char *argv[])
{
	...
	funding.n = 0;
	funding_amount.broneess = 10000000;
	commitment_number = 42;
	to_self_delay = 144;
	dust_limit.broneess = 546;
	 ...
	 */
	to_local.millibroneess = 7000000000;
	to_remote.millibroneess = 3000000000;
	...
	printf("\n"
	       ...
	       to_local.millibroneess, to_remote.millibroneess, feerate_per_kw);
	 ...
	 *    local_feerate_per_kw: 0
	 */
	to_local.millibroneess = 6988000000;
	to_remote.millibroneess = 3000000000;
	feerate_per_kw = 0;
	printf("\n"
	       "name: commitment tx with all five HTLCs untrimmed (minimum feerate)\n"
	...
	do {
		...
		printf("\n"
		       ...
		       : "no outputs???",
		       to_local.millibroneess, to_remote.millibroneess, feerate_per_kw-1);
