...
/* Generated stub for json_to_bro */
bool json_to_bro(const char *buffer UNNEEDED, const jsmntok_t *tok UNNEEDED,
		 struct amount_bro *bro UNNEEDED)
{ fprintf(stderr, "json_to_bro called!\n"); abort(); }
...
int main(int argc, char *argv[])
{
	...
	for (size_t i = ROUTING_MAX_HOPS; i > 2; i--) {
		...
		r = route(tmpctx, global_gossmap, src, dst, AMOUNT_MBRO(1000), 0, 0.0,
			  i - 1, p, &errmsg);
		assert(r);
