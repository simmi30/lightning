#ifndef LIGHTNING_BROCOIN_SIGNATURE_H
#define LIGHTNING_BROCOIN_SIGNATURE_H
#include "config.h"
...
/**
 * brocoin_signature - signature with a sighash type.
 *
...
/**
 * brocoin_tx_hash_for_sig - produce hash for a transaction
 *
 * @tx - tx to hash
...
/**
 * sign_tx_input - produce a brocoin signature for a transaction input
 * @tx: the brocoin transaction we're signing.
...
/**
 * check_tx_sig - produce a brocoin signature for a transaction input
 * @tx: the brocoin transaction which has been signed.
...
#endif /* LIGHTNING_BROCOIN_SIGNATURE_H */
