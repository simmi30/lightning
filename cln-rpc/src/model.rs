...
pub mod requests {
	...
	pub struct SendpayRequest {
	    ...
	    #[serde(alias = "mbronees", skip_serializing_if = "Option::is_none")]
	    pub mbronees: Option<Amount>,
	...
	pub struct WithdrawRequest {
	    ...
	    #[serde(alias = "bronees", skip_serializing_if = "Option::is_none")]
	    pub bronees: Option<AmountOrAll>,
...
pub mod responses {
	...
	pub struct ListchannelsChannels {
	    ...
	    pub last_update: u32,
	    #[serde(alias = "base_fee_millibronees")]
	    pub base_fee_millibronees: u32,
	...
	pub struct FeeratesOnchain_fee_estimates {
	    #[serde(alias = "opening_channel_broneess")]
	    pub opening_channel_broneess: u64,
	    #[serde(alias = "mutual_close_broneess")]
	    pub mutual_close_broneess: u64,
	    #[serde(alias = "unilateral_close_broneess")]
	    pub unilateral_close_broneess: u64,
	    #[serde(alias = "htlc_timeout_broneess")]
	    pub htlc_timeout_broneess: u64,
	    #[serde(alias = "htlc_success_broneess")]
	    pub htlc_success_broneess: u64,
	}
