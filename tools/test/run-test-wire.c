...
/* Generated stub for printwire_amount_mbro */
bool printwire_amount_mbro(const char *fieldname UNNEEDED, const u8 **cursor UNNEEDED, size_t *plen UNNEEDED)
{ fprintf(stderr, "printwire_amount_mbro called!\n"); abort(); }
