...
bool fromwire_gossipd_local_channel_update(const void *p UNNEEDED, struct node_id *id UNNEEDED, struct short_channel_id *short_channel_id UNNEEDED, bool *disable UNNEEDED, u16 *cltv_expiry_delta UNNEEDED, struct amount_mbro *htlc_minimum_mbro UNNEEDED, u32 *fee_base_mbro UNNEEDED, u32 *fee_proportional_millionths UNNEEDED, struct amount_mbro *htlc_maximum_mbro UNNEEDED)
