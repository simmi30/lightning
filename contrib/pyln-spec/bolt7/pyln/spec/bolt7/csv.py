csv = [
    ...
    "msgdata,announcement_signatures,brocoin_signature,signature,",
    ...
    "msgdata,channel_announcement,brocoin_signature_1,signature,",
    "msgdata,channel_announcement,brocoin_signature_2,signature,",
    ...
    "msgdata,channel_announcement,brocoin_key_1,point,",
    "msgdata,channel_announcement,brocoin_key_2,point,",
    ...
    "msgdata,channel_update,htlc_minimum_mbro,u64,",
    "msgdata,channel_update,fee_base_mbro,u32,",
    "msgdata,channel_update,fee_proportional_millionths,u32,",
    "msgdata,channel_update,htlc_maximum_mbro,u64,,option_channel_htlc_max",
