...
def test_bolt_01_csv_tlv():
    ...
    for t in [['0x', ''],
              ...
              ['0x01 00', 'tlv1={amount_mbro=0}'],
              ['0x01 01 01', 'tlv1={amount_mbro=1}'],
              ['0x01 02 0100', 'tlv1={amount_mbro=256}'],
              ['0x01 03 010000', 'tlv1={amount_mbro=65536}'],
              ['0x01 04 01000000', 'tlv1={amount_mbro=16777216}'],
              ['0x01 05 0100000000', 'tlv1={amount_mbro=4294967296}'],
              ['0x01 06 010000000000', 'tlv1={amount_mbro=1099511627776}'],
              ['0x01 07 01000000000000', 'tlv1={amount_mbro=281474976710656}'],
              ['0x01 08 0100000000000000', 'tlv1={amount_mbro=72057594037927936}'],
              ['0x02 08 0000000000000226', 'tlv2={scid=0x0x550}'],
              ['0x03 31 023da092f6980e58d2c037173180e9a465476026ee50f96695963e8efe436f54eb00000000000000010000000000000002', 'tlv3={node_id=023da092f6980e58d2c037173180e9a465476026ee50f96695963e8efe436f54eb,amount_mbro_1=1,amount_mbro_2=2}'],
