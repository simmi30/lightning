...
const struct chainparams *chainparams_by_chainhash(const struct brocoin_blkid *chain_hash UNNEEDED)
...
static struct invalid_stream invalid_streams_n1[] = {
	...
	{ "01 01 00", "encoding for `n1`s `tlv1`s `amount_mbro` is not minimal" },
	{ "01 02 0001", "encoding for `n1`s `tlv1`s `amount_mbro` is not minimal" },
	{ "01 03 000100", "encoding for `n1`s `tlv1`s `amount_mbro` is not minimal" },
	{ "01 04 00010000", "encoding for `n1`s `tlv1`s `amount_mbro` is not minimal" },
	{ "01 05 0001000000", "encoding for `n1`s `tlv1`s `amount_mbro` is not minimal" },
	{ "01 06 000100000000", "encoding for `n1`s `tlv1`s `amount_mbro` is not minimal" },
	{ "01 07 00010000000000", "encoding for `n1`s `tlv1`s `amount_mbro` is not minimal" },
	{ "01 08 0001000000000000", "encoding for `n1`s `tlv1`s `amount_mbro` is not minimal" },
...
static bool tlv_n1_eq(const struct tlv_n1 *a, const struct tlv_n1 *b)
{
	...
	if (a->tlv3) {
		...
		if (!pubkey_eq(&a->tlv3->node_id, &b->tlv3->node_id))
			return false;
		if (!amount_mbro_eq(a->tlv3->amount_mbro_1,
				    b->tlv3->amount_mbro_1))
			return false;
		if (!amount_mbro_eq(a->tlv3->amount_mbro_2,
				    b->tlv3->amount_mbro_2))
			return false;
	} else if (b->tlv3)
		return false;
...
int main(int argc, char *argv[])
{
	...
	tlv3_node_id.amount_mbro_1 = AMOUNT_MBRO(1);
	tlv3_node_id.amount_mbro_2 = AMOUNT_MBRO(2);
