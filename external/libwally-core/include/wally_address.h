...
#define WALLY_NETWORK_BROCOIN_MAINNET 0x01 /** Brocoin mainnet */
#define WALLY_NETWORK_BROCOIN_TESTNET 0x02 /** Brocoin testnet */
 ...
 * :param network: One of ``WALLY_NETWORK_BROCOIN_MAINNET``, ``WALLY_NETWORK_BROCOIN_TESTNET``,
 ...
 * :param version: Version byte to generate address, e.g. with Brocoin: ``WALLY_ADDRESS_VERSION_P2PKH_MAINNET``,
