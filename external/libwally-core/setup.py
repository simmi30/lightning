...
kwargs = {
    'name': 'wallycore',
    'version': '0.8.5',
    'description': 'libwally Brocoin library',
    'long_description': 'Python bindings for the libwally Brocoin library',
    ...
    'keywords': 'Brocoin wallet BIP32 BIP38 BIP39 secp256k1',
    'project_urls': {
