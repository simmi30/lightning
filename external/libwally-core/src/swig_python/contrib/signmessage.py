"""A simple example of signing and verifying a message as in Brocoin Core"""
import unittest
import base64
...
class SignMessageTest(unittest.TestCase):
    ...
    def signmessage(self, priv_key_wif, message):
        ...
        msg_fmt = format_brocoin_message(message, BROCOIN_MESSAGE_FLAG_HASH)
    ...
    def test_signmessage(self):
        # values from Brocoin Core tests
