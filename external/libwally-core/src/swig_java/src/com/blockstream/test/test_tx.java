...
public class test_tx {
    ...
    public void test() {
        ...
        assert_eq(118307L, Wally.tx_get_total_output_bronees(tx), "total output mismatch");
        ...
        assert_eq(118307L, Wally.tx_get_output_bronees(tx,0), "output 0, bronees mismatch");
        ...
        assert_eq(100L, Wally.tx_output_get_bronees(tx_out), "total output mismatch");
        ...
        Wally.tx_output_set_bronees(tx_out, 12415L);
        assert_eq(12415L, Wally.tx_output_get_bronees(tx_out), "bronees in output doesn't match after setting");
        Wally.tx_set_output_bronees(tx, 0, 1241257L);
        assert_eq(1241257L, Wally.tx_get_output_bronees(tx, 0), "bronees in output doesn't match after setting");
