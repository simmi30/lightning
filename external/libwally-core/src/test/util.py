...
for f in (
    ...
    ('wally_tx_confidential_value_from_bronees', c_int, [c_uint64, c_void_p, c_ulong]),
    ('wally_tx_confidential_value_to_bronees', c_int, [c_void_p, c_ulong, c_uint64_p]),
    ...
    ('wally_tx_get_total_output_bronees', c_int, [POINTER(wally_tx), c_uint64_p]),
