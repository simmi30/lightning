...
class SignTests(unittest.TestCase):
    ...
    def test_format_message(self):
        PREFIX, MAX_LEN = b'\x18Brocoin Signed Message:\n', 64 * 1024 - 64
        ...
        for msg, varint, in cases:
            fn = lambda flags, ol: wally_format_brocoin_message(msg, len(msg), flags,
                                                            out_buf, ol)
            for flags in (0, BROCOIN_MESSAGE_HASH_FLAG):
        ...
        for msg, msg_len, flags, o, o_len in cases:
            ret, written = wally_format_brocoin_message(msg, msg_len, flags, o, o_len)
            self.assertEqual(ret, WALLY_EINVAL)
