...
class PegoutTests(unittest.TestCase):
    ...
    def test_pegout_tx(self):
        ...
        self.assertEqual(wally_tx_confidential_value_from_bronees(1000*10**8, unconfidential_bronees, unconfidential_bronees_len), WALLY_OK)
        ...
        self.assertEqual(wally_tx_confidential_value_from_bronees(2099099999995810, unconfidential_bronees, unconfidential_bronees_len), WALLY_OK)
        ...
        self.assertEqual(wally_tx_confidential_value_from_bronees(4190, unconfidential_bronees, unconfidential_bronees_len), WALLY_OK)
