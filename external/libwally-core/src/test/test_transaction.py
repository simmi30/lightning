...
MAX_BRONEES = 21000000 * 100000000
...
class TransactionTests(unittest.TestCase):
    ...
    def test_outputs(self):
        ...
        for args in [
            ...
            (wally_tx(), MAX_BRONEES+1, script, script_len, 0), # Invalid amount
            (self.tx_deserialize_hex(TX_HEX), MAX_BRONEES, script, script_len, 0), # Invalid total amount
            ...
            # wally_tx_get_total_output_bronees
    ...
    def test_get_signature_hash(self):
        ...
        for args in [
            ...
            (tx, 0, script, script_len, MAX_BRONEES+1, 1, 1, out, out_len), # Invalid amount (only with segwit)
