...
def test_bad_announcement(runner: Runner) -> None:
    ...
    ann_bad_brocoinsig1 = funding.channel_announcement("103x1x0", "")
    ann_bad_brocoinsig1.fields["brocoin_signature_1"] = corrupt_sig(
        ann_bad_brocoinsig1.fields["brocoin_signature_1"]
    )

    ann_bad_brocoinsig2 = funding.channel_announcement("103x1x0", "")
    ann_bad_brocoinsig2.fields["brocoin_signature_2"] = corrupt_sig(
        ann_bad_brocoinsig2.fields["brocoin_signature_2"]
    )
        ...
        TryAll(
            ...
            [
                TryAll(
                    ...
                    [RawMsg(ann_bad_brocoin_key1)],
                    [RawMsg(ann_bad_brocoin_key2)],
                ),
                # Needs a channel_update if it were to relay.
                RawMsg(
                    funding.channel_update(
            ...
            [
                TryAll(
                    ...
                    [RawMsg(ann_bad_brocoinsig1)],
                    [RawMsg(ann_bad_brocoinsig2)],
                ),
                ExpectError(),
            ],
        ),
