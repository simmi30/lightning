        ...
        TryAll(
            ...
            [
                Msg(
                    ...
                    funding_broneess=funding_amount_for_utxo(0),
                    push_mbro=0,
                    dust_limit_broneess=546,
                    max_htlc_value_in_flight_mbro=4294967295,
                    channel_reserve_broneess=9998,
                    htlc_minimum_mbro=0,
                    feerate_per_kw=253,
                ...
                Commit(
                    ...
                    local_amount=mbro(sent("funding_broneess", int)),
                    remote_amount=0,
            ...
            [
                ...
                # This gives a channel of 999877bro
                ExpectMsg(
                    "open_channel",
                    chain_hash=regtest_hash,
                ...
                AcceptFunding(
                    ...
                    funding_amount=rcvd("open_channel.funding_broneess", int),
                    local_node_privkey="02",
                    local_funding_privkey=local_funding_privkey,
                    remote_node_privkey=runner.get_node_privkey(),
                    remote_funding_privkey=remote_funding_privkey(),
                ...
                Commit(
                    ...
                    local_amount=0,
                    remote_amount=mbro(rcvd("open_channel.funding_broneess", int)),
                    local_dust_limit=sent("accept_channel.dust_limit_broneess", int),
                    remote_dust_limit=rcvd("open_channel.dust_limit_broneess", int),
