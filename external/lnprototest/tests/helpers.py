...
#    UTXO: d3fb780146954eb42e371c80cbee1725f8ae330848522f105bda24e1fb1fc010/1 (0.01BRON)
#
...
#    UTXO: d3fb780146954eb42e371c80cbee1725f8ae330848522f105bda24e1fb1fc010/0 (0.02BRON)
#
...
#    UTXO: d3fb780146954eb42e371c80cbee1725f8ae330848522f105bda24e1fb1fc010/3 (0.03BRON)
#
...
#    UTXO: d3fb780146954eb42e371c80cbee1725f8ae330848522f105bda24e1fb1fc010/4 (0.04BRON)
#
...
#    UTXO: d3fb780146954eb42e371c80cbee1725f8ae330848522f105bda24e1fb1fc010/2 (48.89994700BRON)
#
#
...
#    UTXO: d3fb780146954eb42e371c80cbee1725f8ae330848522f105bda24e1fb1fc010/5 (0.005BRON)
#
...
#   UTXO: d3fb780146954eb42e371c80cbee1725f8ae330848522f105bda24e1fb1fc010/6 (0.06BRON)
#
...
def utxo(index: int = 0) -> Tuple[str, int, int, str, int]:
    ...
    # Reasonable funding fee in bros
...
def txid_raw(tx: str) -> str:
    ...
    return brocoin.core.CTransaction.deserialize(bytes.fromhex(tx)).GetTxid().hex()
