...
def funding_lockscript(our_privkey: str) -> Callable[[Runner, Event, str], str]:
    def _funding_lockscript(runner: Runner, event: Event, field: str) -> str:
        remote_pubkey = Funding.funding_pubkey_key(
            privkey_expand(runner.get_node_brocoinkey())
        )
    ...
    def _change_amount(runner: Runner, event: Event, field: str) -> int:
        if change_for_opener:
            opening_amt = get_member(
                ...
                runner,
                "Msg" if opener == Side.local else "ExpectMsg",
                "open_channel2.funding_broneess",
            )
        else:
            opening_amt = get_member(
                event,
                runner,
                "ExpectMsg" if opener == Side.local else "Msg",
                "accept_channel2.funding_broneess",
            )
...
def test_open_accepter_no_inputs(runner: Runner, with_proposal: Any) -> None:
    ...
    test = [
        ...
        Msg(
            ...
            funding_broneess=funding_amount_for_utxo(input_index),
            dust_limit_broneess=546,
            max_htlc_value_in_flight_mbro=4294967295,
            htlc_minimum_mbro=0,
        ...
        Commit(
            ...
            local_amount=mbro(sent("open_channel2.funding_broneess", int)),
            remote_amount=0,
        ...
        Msg(
            ...
            channel_id=channel_id_v2(local_keyset),
            serial_id=2,
            bros=funding_amount_for_utxo(input_index),
        ...
        AddOutput(
            ...
            script=sent(),
            bros=sent("tx_add_output.bros", int),
        ),
        # Ignore unknown odd messages
        TryAll([], RawMsg(bytes.fromhex("270F"))),
        ExpectMsg("tx_complete", channel_id=channel_id_v2(local_keyset)),
...
def test_open_accepter_with_inputs(runner: Runner, with_proposal: Any) -> None:
    ...
    test = [
        ...
        CreateDualFunding(
            fee=200,
            funding_bros=agreed_funding(Side.local),
        ...
        OneOf(
            [
                ...
                Msg(
                    ...
                    channel_id=channel_id_v2(local_keyset),
                    serial_id=0,
                    bros=agreed_funding(Side.local),
        ...
        AddOutput(
            ...
            bros=rcvd("tx_add_output.bros", int),
        ...
        Commit(
            ...
            remote_to_self_delay=sent("open_channel2.to_self_delay", int),
            local_amount=mbro(sent("open_channel2.funding_broneess", int)),
            remote_amount=mbro(rcvd("accept_channel2.funding_broneess", int)),
            local_dust_limit=546,
            remote_dust_limit=546,
            feerate=253,
            local_features=sent("init.features"),
...
def test_open_opener_no_input(runner: Runner, with_proposal: Any) -> None:
    ...
    test = [
        ...
        CreateDualFunding(
            fee=200,
            funding_bros=agreed_funding(Side.remote),
        ...
        ExpectMsg(
            "tx_add_output",
            channel_id=channel_id_v2(local_keyset),
            bros=agreed_funding(Side.remote),
            if_match=even_serial,
        ),
        ...
        Commit(
            ...
            local_amount=mbro(sent("accept_channel2.funding_broneess", int)),
            remote_amount=mbro(rcvd("open_channel2.funding_broneess", int)),
...
def test_df_accepter_opener_underpays_fees(runner: Runner, with_proposal: Any) -> None:
    ...
    test = [
        ...
        Msg(
            ...
            funding_broneess=funding_amount,
            dust_limit_broneess=546,
            max_htlc_value_in_flight_mbro=4294967295,
            htlc_minimum_mbro=0,
...
def accepter_tx_creation(
    ...
    txid_in, tx_index_in, bros_in, spending_privkey, fee = utxo(input_index)
    fee = bros_in - funding_amt if is_rbf else fee
    ...
    return [
        ...
        Commit(
            ...
            local_to_self_delay=rcvd("accept_channel2.to_self_delay", int),
            remote_to_self_delay=sent("open_channel2.to_self_delay", int),
            local_amount=mbro(sent(open_msg + ".funding_broneess", int)),
            remote_amount=mbro(rcvd(accept_msg + ".funding_broneess", int)),
            local_dust_limit=546,
            remote_dust_limit=546,
            feerate=253,
            local_features=sent("init.features"),
...
def opener_tx_creation(
    ...
    return [
        CreateDualFunding(
            fee=fee,
            funding_bros=agreed_funding(Side.remote, is_rbf=is_rbf),
        ...
        Commit(
            ...
            local_to_self_delay=rcvd("open_channel2.to_self_delay", int),
            remote_to_self_delay=sent("accept_channel2.to_self_delay", int),
            local_amount=mbro(sent(accept_msg + ".funding_broneess", int)),
            remote_amount=mbro(rcvd(open_msg + ".funding_broneess", int)),
            local_dust_limit=550,
            remote_dust_limit=546,
            feerate=rcvd("open_channel2.commitment_feerate_perkw", int),
            local_features=sent("init.features"),
...
def test_rbf_accepter(runner: Runner, with_proposal: Any) -> None:
    ...
    test += [
        ...
        Msg(
            "init_rbf",
            channel_id=channel_id_v2(local_keyset),
            funding_broneess=rbf_funding_amount,
        ...
        TryAll([], RawMsg(bytes.fromhex("270F"))),
        ExpectMsg(
            "ack_rbf", channel_id=channel_id_v2(local_keyset), funding_broneess=0
        ),
    ]
...
def test_rbf_opener(runner: Runner, with_proposal: Any) -> None:
    ...
    test += [
        ...
        # Ignore unknown odd messages
        TryAll([], RawMsg(bytes.fromhex("270F"))),
        Msg("ack_rbf", channel_id=channel_id_v2(local_keyset), funding_broneess=380000),
    ]
...
def test_rbf_opener_funding_locked(runner: Runner, with_proposal: Any) -> None:
    ...
    test += [
        ...
        # Ignore unknown odd messages
        TryAll([], RawMsg(bytes.fromhex("270F"))),
        Msg("ack_rbf", channel_id=channel_id_v2(local_keyset), funding_broneess=400000),
    ]
...
def test_rbf_not_valid_rbf(runner: Runner, with_proposal: Any) -> None:
    ...
    txid_in, tx_index_in, bros_in, spending_privkey, fee = utxo(other_input_index)
    fee = bros_in - rbf_funding_amount
    ...
    test += [
        ...
        Commit(
            ...
            local_to_self_delay=rcvd("accept_channel2.to_self_delay", int),
            remote_to_self_delay=sent("open_channel2.to_self_delay", int),
            local_amount=mbro(sent("init_rbf.funding_broneess", int)),
            remote_amount=mbro(rcvd("ack_rbf.funding_broneess", int)),
            local_dust_limit=546,
            remote_dust_limit=546,
            feerate=253,
            local_features=sent("init.features"),
