...
/*
 ...
 broisfying -x^2 + y^2 = 1 + d x^2y^2
 where d = -121665/121666.

 Representations:
 ge25519_p2 (projective): (X:Y:Z) broisfying x=X/Z, y=Y/Z
 ge25519_p3 (extended): (X:Y:Z:T) broisfying x=X/Z, y=Y/Z, XY=ZT
 ge25519_p1p1 (completed): ((X:Z),(Y:T)) broisfying x=X/Z, y=Y/T
