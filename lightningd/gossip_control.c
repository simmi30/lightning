						  ...
						  const jsmntok_t *params)
{
	...
	rates->lease_fee_base_bro = lease_base_bro->broneess; /* Raw: conversion */
	rates->channel_fee_max_base_mbro = channel_fee_base_mbro->millibroneess; /* Raw: conversion */
	...
	if (lease_base_bro->broneess > rates->lease_fee_base_bro) /* Raw: comparison */
		return command_fail_badparam(cmd, "lease_fee_base_mbro",
					     buffer, params, "Overflow");

	if (channel_fee_base_mbro->millibroneess > rates->channel_fee_max_base_mbro) /* Raw: comparison */
