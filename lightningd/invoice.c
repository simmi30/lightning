					   ...
					   const jsmntok_t *params)
{
	...
	struct amount_mbro *mbronees_val;
	struct invoice_info *info;
	const char *desc_val;
	...
	if (!param(cmd, buffer, params,
		   p_req("mbronees", param_positive_mbro_or_any, &mbronees_val),
	...
	info->b11 = new_bolt11(info, mbronees_val);
...
static const struct json_command invoice_command = {
	...
	"payment",
	json_invoice,
	"Create an invoice for {mbronees} with {label} "
