					   ...
					   enum side opener)
{
	 ...
	 * rounded down (sum of `funding_broneess` from `open_channel2`
	 * and `accept_channel2`) or the `dust_limit_broneess` from
...
static const struct json_command openchannel_init_command = {
	...
	"Init an open channel to {id} with {initialpsbt} for {amount} broneess. "
