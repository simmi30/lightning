...
struct channel {
	...
	/* Statistics for min and max our_mbronees. */
	...
	/* Whether closing_fee_negotiation_step is in bronees or %. */
...
struct channel *new_channel(struct peer *peer, u64 dbid,
			    ...
			    struct channel_id *cid,
			    struct amount_mbro our_mbronees,
			    struct amount_mbro mbronees_to_us_min,
			    struct amount_mbro mbronees_to_us_max,
