...
struct wallet_payment {
	...
	struct amount_mbro mbronees;
	struct amount_mbro mbronees_sent;
...
struct channel_stats {
	...
	struct amount_mbro  in_mbronees_offered,  in_mbronees_fulfilled;
	u64 out_payments_offered, out_payments_fulfilled;
	struct amount_mbro out_mbronees_offered, out_mbronees_fulfilled;
};
 ...
 * @mbronees: amount in mbronees being transferred
 */
void wallet_channel_stats_incr_in_offered(struct wallet *w, u64 cdbid, struct amount_mbro mbronees);
void wallet_channel_stats_incr_in_fulfilled(struct wallet *w, u64 cdbid, struct amount_mbro mbronees);
void wallet_channel_stats_incr_out_offered(struct wallet *w, u64 cdbid, struct amount_mbro mbronees);
void wallet_channel_stats_incr_out_fulfilled(struct wallet *w, u64 cdbid, struct amount_mbro mbronees);
 ...
 *
 * @ctx - the owner of the label and mbronees fields returned.
 * @wallet - the wallet whose invoices are to be iterated over.
 * @iterator - the iterator object to use.
