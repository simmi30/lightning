...
PRINTWIRE_STRUCT_TYPE_TO_STRING(brocoin_blkid)
PRINTWIRE_STRUCT_TYPE_TO_STRING(brocoin_txid)
...
PRINTWIRE_ASSIGNABLE_STRUCT_TO_STRING(amount_bro)
PRINTWIRE_ASSIGNABLE_STRUCT_TO_STRING(amount_mbro)
