...
void towire_added_htlc(u8 **pptr, const struct added_htlc *added)
{
	...
	towire_amount_mbro(pptr, added->amount);
...
void towire_existing_htlc(u8 **pptr, const struct existing_htlc *existing)
{
	...
	towire_amount_mbro(pptr, existing->amount);
...
void towire_simple_htlc(u8 **pptr, const struct simple_htlc *simple)
{
	...
	towire_amount_mbro(pptr, simple->amount);
			 ...
			 struct added_htlc *added)
{
	...
	added->amount = fromwire_amount_mbro(cursor, max);
					     ...
					     const u8 **cursor, size_t *max)
{
	...
	existing->amount = fromwire_amount_mbro(cursor, max);
					 ...
					 const u8 **cursor, size_t *max)
{
	...
	simple->amount = fromwire_amount_mbro(cursor, max);
