...
WARN_UNUSED_RESULT bool lease_rates_set_chan_fee_base_mbro(struct lease_rates *rates, struct amount_mbro amt);

WARN_UNUSED_RESULT bool lease_rates_set_lease_fee_bro(struct lease_rates *rates, struct amount_bro amt);
