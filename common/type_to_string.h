...
union printable_types {
	...
	const struct brocoin_txid *brocoin_txid;
	const struct brocoin_blkid *brocoin_blkid;
	const struct brocoin_outpoint *brocoin_outpoint;
	const struct sha256 *sha256;
	const struct sha256_double *sha256_double;
	const struct ripemd160 *ripemd160;
	const struct brocoin_tx *brocoin_tx;
	...
	const struct brocoin_signature *brocoin_signature;
	const struct bip340sig *bip340sig;
	const struct channel *channel;
	const struct amount_mbro *amount_mbro;
	const struct amount_bro *amount_bro;
