...
static inline struct amount_bro commit_tx_base_fee(u32 feerate_per_kw,
 ...
 * @funding, @funding_bros: funding outpoint and amount
 * @funding_wscript: scriptPubkey of the funding output
 * @funding_keys: funding brocoin keys
