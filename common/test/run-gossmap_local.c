...
int main(int argc, char *argv[])
{
	...
	u32 timestamp, fee_base_mbro, fee_proportional_millionths;
	...
	assert(gossmap_chan_get_capacity(map, gossmap_find_chan(map, &scid23),
					 &capacity));
	assert(amount_bro_eq(capacity, AMOUNT_BRO(1000000)));
	...
	assert(fee_base_mbro == 20);
	assert(fee_proportional_millionths == 1000);
	assert(amount_mbro_eq(htlc_minimum_mbro, AMOUNT_MBRO(0)));
	assert(amount_mbro_eq(htlc_maximum_mbro, AMOUNT_MBRO(990000000)));
