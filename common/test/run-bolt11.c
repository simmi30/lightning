...
int main(int argc, char *argv[])
{
	 ...
	 */
	mbronees = AMOUNT_MBRO(2500 * (1000ULL * 100000000) / 1000000);
	b11 = new_bolt11(tmpctx, &mbronees);
	b11->chain = chainparams_for_network("brocoin");
	b11->timestamp = 1496314658;
	b11->payment_secret = tal(b11, struct secret);
	memset(b11->payment_secret, 0x11, sizeof(*b11->payment_secret));
	 ...
	 */
	mbronees = AMOUNT_MBRO(20 * (1000ULL * 100000000) / 1000);
	b11 = new_bolt11(tmpctx, &mbronees);
	b11->chain = chainparams_for_network("brocoin");
	b11->timestamp = 1496314658;
	b11->payment_secret = tal(b11, struct secret);
	...
	if (!node_id_from_hexstr("02330d13587b67a85c0a36ea001c4dba14bcd48dda8988f7303275b040bffb6abd", strlen("02330d13587b67a85c0a36ea001c4dba14bcd48dda8988f7303275b040bffb6abd"), &node))
		abort();
	mbronees = AMOUNT_MBRO(3000000000);
	b11 = new_bolt11(tmpctx, &mbronees);
	 ...
	 */
	mbronees = AMOUNT_MBRO(25 * (1000ULL * 100000000) / 1000);
	b11 = new_bolt11(tmpctx, &mbronees);
	b11->chain = chainparams_for_network("brocoin");
	b11->timestamp = 1496314658;
	if (!hex_decode("0001020304050607080900010203040506070809000102030405060708090102",
	 ...
	 *
	 * * `lnbc`: prefix, Lightning on brocoin mainnet
	 * * `9678785340p`: amount (9678785340 pico-brocoin = 967878534 milli bronees)
	 * * `1`: Bech32 separator
	 ...
	 */
	mbronees = AMOUNT_MBRO(967878534);
	b11 = new_bolt11(tmpctx, &mbronees);
	b11->chain = chainparams_for_network("brocoin");
	 ...
	 */
	mbronees = AMOUNT_MBRO(1000000000);
	b11 = new_bolt11(tmpctx, &mbronees);
	b11->chain = chainparams_for_network("brocoin");
	b11->timestamp = 1496314658;
	if (!hex_decode("0001020304050607080900010203040506070809000102030405060708090102",
	...
	/* BOLT #11:
	 * > ### Invalid sub-millibronees precision.
	...
	assert(streq(fail, "Invalid sub-millibronees amount '2500000001p'"));
