...
int main(int argc, char *argv[])
{
	...
	dij = dijkstra(tmpctx, gossmap, b_node, AMOUNT_MBRO(1000), riskfactor,
		       route_can_carry_unless_disabled,
		       route_score_cheaper, NULL);

	route = route_from_dijkstra(tmpctx, gossmap, dij, a_node, AMOUNT_MBRO(1000), 10);
	assert(route);
	assert(tal_count(route) == 1);
	assert(amount_mbro_eq(route[0].amount, AMOUNT_MBRO(1000)));
	...
	assert(amount_mbro_eq(route[1].amount, AMOUNT_MBRO(1000)));
	assert(route[1].delay == 11);
	assert(amount_mbro_eq(route[0].amount, AMOUNT_MBRO(1001)));
	...
	dij = dijkstra(tmpctx, gossmap, c_node, AMOUNT_MBRO(3000000), riskfactor,
		       route_can_carry_unless_disabled,
		       route_score_cheaper, NULL);
	route = route_from_dijkstra(tmpctx, gossmap, dij, a_node,
				    AMOUNT_MBRO(3000000), 13);
	assert(route);
	assert(tal_count(route) == 2);
	assert(channel_is_between(gossmap, &route[0], a_node, b_node));
	assert(channel_is_between(gossmap, &route[1], b_node, c_node));
	assert(amount_mbro_eq(route[1].amount, AMOUNT_MBRO(3000000)));
	assert(route[1].delay == 13);
	assert(amount_mbro_eq(route[0].amount, AMOUNT_MBRO(3000000 + 3 + 1)));
	...
	assert(amount_mbro_eq(route[0].amount, AMOUNT_MBRO(3000000 + 6)));
