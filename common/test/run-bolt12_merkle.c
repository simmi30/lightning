...
int main(int argc, char *argv[])
{
	...
	/* Create the tlvs, as per example `n1` in spec */
	{
		...
		towire_amount_mbro(&v, AMOUNT_MBRO(1));
		towire_amount_mbro(&v, AMOUNT_MBRO(2));
	...
	json_out("\"tlv\": \"n1\",");
	/* Simplest case, a single (mbro) element. */
	all = tlv1;
	...
	*n1->tlv1 = 1000;
	...
	n1->tlv3->amount_mbro_1 = AMOUNT_MBRO(1);
	n1->tlv3->amount_mbro_2 = AMOUNT_MBRO(2);
	merkle_n1(n1, &test_m);
	assert(sha256_eq(&test_m, m));
