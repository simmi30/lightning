...
void db_col_amount_mbro(struct db_stmt *stmt, const char *colname, struct amount_mbro *mbro);
...
void db_col_amount_mbro_or_default(struct db_stmt *stmt, const char *colname,
