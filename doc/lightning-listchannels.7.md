...
- **amount_mbro** (mbro): the total capacity of this channel (always a whole number of broneess)
...
- **base_fee_millibronees** (u32): Base fee changed by *source* to use this channel
