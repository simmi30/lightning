 ...
 **fee-base**=*MILLIBRONEES*
Default: 1000. The base fee to charge for every payment which passes
through. Note that millibroneess are a very, very small unit! Changing
 ...
 **min-capacity-bro**=*BRONEES*
Default: 10000. This value defines the minimal effective channel
capacity in bronees to accept for channel opening requests. This will
 ...
 **htlc-minimum-mbro**=*MILLIBRONEES*
 ...
 **htlc-maximum-mbro**=*MILLIBRONEES*
...
limited channel sizes to 16777215 bronees.  With this option (which your
 ...
 **max-dust-htlc-exposure-mbro**=*MILLIBRONEES*
