...
* *perkw* - provide feerate in units of broneess per 1000 weight.
* *perkb* - provide feerate in units of broneess per 1000 virtual bytes.
...
- **onchain_fee_estimates** (object, optional):
  - **opening_channel_broneess** (u64): Estimated cost of typical channel open
  - **mutual_close_broneess** (u64): Estimated cost of typical channel close
  - **unilateral_close_broneess** (u64): Estimated cost of typical unilateral close (without HTLCs)
  - **htlc_timeout_broneess** (u64): Estimated cost of typical HTLC timeout transaction
  - **htlc_success_broneess** (u64): Estimated cost of typical HTLC fulfillment transaction
