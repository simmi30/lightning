...
**pay** *bolt11* [*mbronees*] [*label*] [*riskfactor*]
...
contain an amount, *mbronees* is required, otherwise if it is specified
it must be *null*. *mbronees* is in millibronees precision; it can be a
...
`exemptfee` (default: 5000 millibronees).
