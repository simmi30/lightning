...
to add an HTLC for 1002 millibroneess and a delay of 21 blocks on top of the current blockheight:
...
The *mbronees* parameter is used to annotate the payment, and is returned by
